...
Route::prefix('api')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware('tenant')->group(function () {
            ...
            Route::get('/finance/report', [FinanceController::class, 'report'])->middleware('permission:finance.view');
            Route::post('/finance/payments/{submission}/decision', [FinanceController::class, 'decidePayment'])->middleware('permission:finance.approve');
            Route::get('/hr/overview', [HrController::class, 'overview'])->middleware('permission:hr.view');
            Route::post('/hr/attendance', [HrController::class, 'storeAttendance'])->middleware('permission:hr.manage_attendance');
            Route::post('/hr/leave-requests', [HrController::class, 'storeLeaveRequest'])->middleware('permission:hr.manage_leave');
            Route::post('/hr/leave-requests/{leaveRequest}/decision', [HrController::class, 'decideLeaveRequest'])->middleware('permission:hr.manage_leave');
            Route::post('/hr/trainings', [HrController::class, 'storeTraining'])->middleware('permission:hr.manage_training');
            Route::patch('/hr/training-participants/{participant}', [HrController::class, 'updateTrainingParticipant'])->middleware('permission:hr.manage_training');
            Route::get('/safety/overview', [SafetyController::class, 'overview'])->middleware('permission:safety.view');
            Route::post('/safety/incidents', [SafetyController::class, 'storeIncident'])->middleware('permission:safety.manage_incidents');
            Route::patch('/safety/incidents/{incident}', [SafetyController::class, 'updateIncident'])->middleware('permission:safety.manage_incidents');
            Route::post('/safety/inspections', [SafetyController::class, 'storeInspection'])->middleware('permission:safety.inspect');
            Route::post('/safety/ppe', [SafetyController::class, 'storePpeAssignment'])->middleware('permission:safety.manage_equipment');
            Route::post('/safety/ppe/{assignment}/return', [SafetyController::class, 'returnPpeAssignment'])->middleware('permission:safety.manage_equipment');
