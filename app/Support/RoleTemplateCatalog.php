...
final class RoleTemplateCatalog
{
    ...
    public const TEMPLATES = [
        ...
        'sewing-operator' => ['Sewing Operator', 'sewing', ['production.view', 'production.execute', 'quality.view', 'maintenance.view', 'maintenance.create']],
        'mixing-operator' => ['Mixing Operator', 'mixing', ['production.view', 'production.execute', 'inventory.view', 'inventory.issue', 'quality.view', 'maintenance.view', 'maintenance.create']],
        'processing-operator' => ['Processing Operator', 'processing', ['production.view', 'production.execute', 'inventory.view', 'inventory.issue', 'quality.view', 'maintenance.view', 'maintenance.create']],
        'bottling-operator' => ['Bottling Operator', 'bottling', ['production.view', 'production.execute', 'quality.view', 'maintenance.view', 'maintenance.create']],
        'packaging-operator' => ['Packaging Operator', 'packaging', ['production.view', 'production.execute', 'inventory.view', 'inventory.issue', 'quality.view', 'maintenance.view', 'maintenance.create']],
