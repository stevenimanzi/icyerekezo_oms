...
final class RoleTemplateCatalog
{
    ...
    public const TEMPLATES = [
        ...
        'packaging-operator' => ['Packaging Operator', 'packaging', ['production.view', 'production.execute', 'inventory.view', 'inventory.issue', 'quality.view', 'maintenance.view', 'maintenance.create', 'reports.view', 'sales.view', 'sales.pack']],
        ...
        'logistics-officer' => ['Logistics Officer', 'logistics', ['logistics.*', 'sales.view', 'inventory.view', 'inventory.issue', 'reports.view']],
