...
class FactorySettingsController extends Controller
{
    public function show(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'report_departments' => Department::withoutGlobalScopes()->where('factory_id', $factory->id)->where('is_active', true)->orderBy('name')->get(['id', 'name', 'code']),
        ]);
    }
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'settings.report.footer_text' => ['sometimes', 'nullable', 'string', 'max:180'],
            ...
            'settings.report.department_ids' => ['sometimes', 'array'],
            'settings.report.department_ids.*' => [
                'integer',
                'distinct',
                Rule::exists('departments', 'id')->where('factory_id', $factory->id)->where('is_active', true),
            ],
        ]);
    ...
    private function defaults(array $settings, ?string $industry = null): array
    {
        ...
        $defaults = [
            ...
            'report' => [
                ...
                'footer_text' => 'Generated by ICYEREKEZO OMS',
                'default_period' => 'day',
