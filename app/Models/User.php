...
#[Fillable(['current_factory_id', 'school_id', 'name', 'username', 'email', 'locale', 'timezone', 'password', 'last_login_at', 'last_login_ip', 'is_platform_admin', 'is_active', 'email_verified_at', 'otp_code', 'otp_expires_at', 'otp_attempts'])]
