      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 20px 45px rgba(15,32,79,0.08);">
        ...
        <tr>
          <td style="padding:28px 40px 0;">
            <p style="margin:0 0 6px; font-size:12px; font-weight:800; letter-spacing:0.14em; text-transform:uppercase; color:#2563eb;">Verify your email</p>
            <h1 style="margin:0 0 12px; font-size:24px; line-height:1.3; color:#0b1f4d;">Confirm it's you, {{ $recipientName }}</h1>
            <p style="margin:0 0 26px; font-size:14px; line-height:1.6; color:#5b6b8c;">
              Enter this code to finish setting up your ICYEREKEZO OMS account. It expires in {{ $expiresInMinutes }} minutes.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:24px 40px 0;">
            <p style="margin:0; font-size:13px; line-height:1.65; color:#7a89a8;">
              Didn't try to create an ICYEREKEZO OMS account? You can safely ignore this email — no account will be activated without this code.
            </p>
          </td>
        </tr>
