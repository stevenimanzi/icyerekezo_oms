        ...
        <tr>
          <td style="padding:28px 40px 0;">
            ...
            <p style="margin:0 0 26px; font-size:14px; line-height:1.6; color:#5b6b8c;">
              The {{ $planName }} plan for <strong style="color:#0b1f4d;">{{ $factoryName }}</strong> ends on {{ $endsAt->format('l, F j, Y') }}. Renew before then so your team doesn't lose access to your factory's data and daily work.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:24px 40px 0;">
            <p style="margin:0; font-size:13px; line-height:1.65; color:#7a89a8;">
              Once the subscription ends, everyone on your team will lose access to {{ $factoryName }} until it is renewed. Contact the person who manages your account, or renew from Factory Settings, to keep things running smoothly.
            </p>
          </td>
        </tr>
