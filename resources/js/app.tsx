...
const copy = {
  ...
  fr: {
    ...
    returnsHistory: "Historique des retours",
    agreement: "Accord",
...
function Dashboard({ user, onLogout, onMaintenance }: { user: AuthUser; onLogout: () => void; onMaintenance: (message: string) => void }) {
  ...
  const isInternalAuditor = hasRole("internal-auditor");
    const nav = useMemo(() => (user.is_platform_admin ? [
        ...
        ["order-history", FileText, t.orderHistory, "*"],
        ["financials", CreditCard, t.financialRecords, "*"],
        ["return-items", RotateCcw, t.returnItems, "*"],
        ["returns-history", RefreshCw, t.returnsHistory, "*"],
        ["agreement", FileSignature, t.agreement, "*"],
        ["school-profile", Building2, t.schoolProfile, "*"],
        ...
        ? {
            ...(schoolAuth
                ? {
                    ...
                    email: mode === "login" ? "Email or Username" : "Email address",
                ...
                : {
                    ...
                    emailPlaceholder: mode === "login" ? "owner@company.com or username" : "owner@company.com",
        ...
        : {
            ...(schoolAuth
                ? {
                    ...
                    email: mode === "login" ? "E-mail ou nom d'utilisateur" : "Adresse e-mail",
                ...
                : {
                    ...
                    emailPlaceholder: mode === "login" ? "nom@entreprise.com ou nom d'utilisateur" : "nom@entreprise.com",
                    passwordPlaceholder: "Saisissez votre mot de passe",
                    confirmPlaceholder: "Saisissez encore le mot de passe",
