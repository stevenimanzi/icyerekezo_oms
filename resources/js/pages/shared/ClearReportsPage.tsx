            ...
            <header>
              ...
              <div className="noguchi-cutting-table-wrap" style={{ overflowX: 'auto' }}><table><thead>
                  <tr>
                      ...
                      <th colSpan={3} style={{textAlign: 'center', padding: '8px'}}>INPUT</th>
                      <th colSpan={4} style={{textAlign: 'center', padding: '8px'}}>OUTPUT</th>
                  </tr>
                  <tr>
        ...
        <header>
          ...
          <div className="noguchi-cutting-table-wrap" style={{ overflowX: 'auto' }}><table><thead>
              ...
              {day.departments.map((department: any) => department.records.map((record: any, index: number) => {
                  ...
                  const color = info.color !== '—' ? info.color : (fabricColor || '\u2014');
